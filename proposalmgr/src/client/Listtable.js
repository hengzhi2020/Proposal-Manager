                  ...
                  <Table basic="very" celled collapsing>
                    <Table.Body>
                      <Table.Row>
                        <Table.Cell>
                          <Header as="h4">
                            <Header.Content>Proposal_ID</Header.Content>
                          </Header>
                        </Table.Cell>
                      ...
                      <Table.Row>
                        <Table.Cell>
                          <Header as="h4">
                            <Header.Content>Sponsor</Header.Content>
                          </Header>
                        </Table.Cell>
                      ...
                      <Table.Row>
                        <Table.Cell>
                          <Header as="h4">
                            <Header.Content>UpdateTime</Header.Content>
                          </Header>
                        </Table.Cell>
            ...
            <Table.Cell textAlign="center">
              {' '}
              {
                <button
                  key={i}
                  type="button"
                  className="btn-report-score-hover"
                  value={item.id}
                  onClick={props.reportScoreHandler}
                >
                  Score
                </button>
              }
  ...
  return (
    <main className="table-container">
      <Table celled padded>
        ...
        <Table.Body>{proposalList}</Table.Body>
