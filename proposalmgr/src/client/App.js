...
class App extends Component {
  ...
  getProposalTotalNumber() {
    fetch(`${process.env.REACT_APP_BACKEND_URL}proposals/num`)
  ...
  getProposals(pageSize, pageNumber) {
    ...
    fetch(
      `${process.env.REACT_APP_BACKEND_URL}proposals?pageSize=${pageSize}&pageNumber=${pageNumber}`
    )
      .then((response) => response.json())
      .then((mypro) => {
        this.setState({
  ...
  getSearchDataFromDB(searchTitle, searchDate, searchCombine) {
    ...
    fetch(
      `${process.env.REACT_APP_BACKEND_URL}proposals/search?searchTitle=${searchTitle}&searchDate=${searchDate}&searchCombine=${searchCombine}`
    )
      .then((response) => response.json())
      .then((mysearch) => {
        this.setState({
  ...
  getReviewerList() {
    ...
    fetch(`${process.env.REACT_APP_BACKEND_URL}reviewerlist`)
      .then((response) => response.json())
      .then((reviewerlist) => {
        this.setState({
