      ...
      <div className="reviewreportdisplayscroll">
        ...
        {!!this.props.reviewdata &&
          this.props.reviewdata.map((item, i) => {
            if (!!item.business_score | (item.business_comms !== '_')) {
              return (
                <Table key={i}>
                  <Table.Header>
                    <Table.Row>
                  ...
                  <Table.Body className="reportprint-tbl">
                    <Table.Row>
                      ...
                      <Table.Cell>{item.business_comms}</Table.Cell>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>
                        2. Feasibility ({item.feasibility_score})
                      </Table.Cell>
                      <Table.Cell>{item.feasibility_comms}</Table.Cell>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>
                        3. Resources ({item.resources_score})
                      </Table.Cell>
                      <Table.Cell>{item.resources_comms}</Table.Cell>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>
                        4. Commitment ({item.commitment_score})
                      </Table.Cell>
                      <Table.Cell>{item.commitment_comms}</Table.Cell>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>
                        5. Constraints ({item.constraints_score})
                      </Table.Cell>
                      <Table.Cell>{item.constraints_comms}</Table.Cell>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>6. Overall Comments</Table.Cell>
                      <Table.Cell>{item.overall_comms}</Table.Cell>
                    </Table.Row>
                  </Table.Body>
                </Table>
              );
