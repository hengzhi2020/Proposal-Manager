            ...
            <div>
                ...
                <div className='Comm_6_right' >
                    <Form success onSubmit={this.handleSubmit}>
                        <h3 id='textlabel'> Based on the scores you gave, please type in your "Overall Comments" first, SAVE the Scores & Comments, double check the next tab "Final Review", and SUBMIT your final Review Report (reminder: you cannot change your Scores & Comments after SUBMIT)</h3>
                        <textarea id='Comm_textarea6' placeholder='Write Overall Comments' value={this.state.value} onChange={this.handleChange} />
                    </Form>
                </div>
